...
public enum AccessLevel {
  ...
  PatadminTreatment(null, new UnitType[]{UnitType.Treatment}, null, new AccessLevel[]{PatadminRoot}),
  PatadminPostprocessing(null, new UnitType[]{UnitType.Postprocessing}, null, new AccessLevel[]{PatadminRoot}),
  PatadminTransport(null, new UnitType[]{UnitType.Postprocessing}, null, new AccessLevel[]{PatadminRoot}),
  PatadminInfo(null, new UnitType[]{UnitType.Info}, null, new AccessLevel[]{PatadminRoot}),
  Patadmin(PatadminRegistration, PatadminTreatment, PatadminPostprocessing, PatadminTransport, PatadminInfo, PatadminRoot),
  Edit(Authority.MLS),
